...
def toolbox_talk_page(page: ft.Page | None = None) -> ft.Control:
    ...
    root = ft.Column(
        controls=[
            ...
            ft.Row(
                controls=[
                    ft.OutlinedButton("Statistiques (6 mois)", icon=ft.Icons.BAR_CHART_OUTLINED, on_click=toggle_stats),
                    ft.OutlinedButton("Journal d'audit", icon=ft.Icons.HISTORY_OUTLINED, on_click=toggle_audit),
                ],
                spacing=10,
            ),
            stats_container,
