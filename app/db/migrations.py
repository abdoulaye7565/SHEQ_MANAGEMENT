...
def run_lightweight_migrations(connection: sqlite3.Connection) -> None:
    ...
    _ddl_changes = sum([
        ...
        _add_column_if_missing(connection, "drilling_reports", "operator_signature", "TEXT"),
        _add_column_if_missing(connection, "drilling_reports", "supervisor_signature", "TEXT"),
